...
assert sys.version_info >= (2,), "Only Python 3 is currently supported."
global facebook_username
global facebook_password
facebook_username = "" #please fill your login credentials within the double quotes
facebook_password = ""
...
for person in peoplelist:
    body = "<tbody>" \
            ...
            "</tr>" \
            "</tbody>" % (person.person_imagelink, person.person_imagelink, person.full_name,"", "", "", person.facebook, person.facebookcdnimage, person.facebook,"","", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "")
